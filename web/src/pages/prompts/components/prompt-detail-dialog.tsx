                    ...
                    <>
                        <div className="grid gap-5 md:grid-cols-[300px_minmax(0,1fr)]">
                            <div className="space-y-3">
                                {prompt.coverUrl?.trim() ? (
                                    <img src={prompt.coverUrl.trim()} alt={prompt.title} className="aspect-[4/3] w-full rounded-lg object-cover" />
                                ) : (
                                    <div className="flex aspect-[4/3] w-full items-center justify-center rounded-lg bg-stone-100 text-xs text-stone-400 dark:bg-stone-900 dark:text-stone-500">无封面</div>
                                )}
